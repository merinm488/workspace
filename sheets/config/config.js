...
const APP_CONFIG = {
    ...
    storage: {
        ...
        // Collection ID is handled server-side in api/storage.js
        ...
        // Local storage keys
        keys: {
            spreadsheetData: 'sheets_spreadsheet_data',
            theme: 'sheets_theme',
            recentFiles: 'sheets_recent_files',
            userSettings: 'sheets_user_settings',
        },
    },
